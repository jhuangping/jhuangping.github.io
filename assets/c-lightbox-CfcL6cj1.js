...
`),l("span",{class:"p"},"@include"),s(),l("span",{class:"b"},"components.lightbox"),s(`() {
  自訂樣式 ...
}`)])],-1))]),_:1})])}const f={},C=g(f,[["render",x]]);export{C as default};
