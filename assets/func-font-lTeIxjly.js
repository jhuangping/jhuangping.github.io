import{_ as m}from"./LatticeBlock-CUTZpv0x.js";import{_ as f}from"./LatticeTable-BlpplT7t.js";import{_ as b}from"./LatticeGrammar-C35fjvlw.js";import{_}from"./LatticeScssCode-BG3glMV4.js";import{_ as g}from"./LatticeHeadline-CuMDeEiL.js";import{r as p,c as w,e as o,s as i,b as v,a as l,A as n}from"./index-CRgGQZIT.js";const N={__name:"func-font",setup($){const a=p({columns:["參數","說明","預設"],rows:[{cells:["<code>$fontVal</code>","設定檔內的字型 key","—"]},{cells:["<code>$default</code>","fallback 字型清單","<code>$fontDefault</code>"]}]}),t=p({columns:["參數","說明","預設"],rows:[{cells:["<code>$val</code>","字重名稱 / 縮寫 / 數字","<code>base</code>"]}]});return(y,s)=>{const d=g,e=_,c=b,u=f,r=m;return v(),w("div",null,[o(d,{title:"font",subtitle:"font"}),o(r,{label:"字型設定工具"},{default:i(()=>[o(e,{code:"font()"}),s[0]||(s[0]=l("p",null,[n("從設定檔 "),l("code",null,"$useFont"),n(" 取得字型名稱，並自動補上 fallback 字型"),l("br"),n(" 這樣可以避免瀏覽器找不到主要字型時，顯示錯誤或不一致的字體 ")],-1)),o(c,{code:"font",var:"$fontVal, $default"}),o(u,{columns:a.value.columns,rows:a.value.rows},null,8,["columns","rows"]),s[1]||(s[1]=l("h4",{class:"mb:2"},"使用範例",-1)),s[2]||(s[2]=l("pre",null,[l("code",null,[l("span",{class:"o"},".title"),n(` {
