...
`),n("span",{class:"p"},"@include"),s(),n("span",{class:"b"},"px"),s("();")])],-1)])]),_:1}),a(u,{value:"1"},{default:o(()=>[...l[3]||(l[3]=[n("pre",null,[n("code",null,[n("span",{class:"gy"},"// 左右 padding 相同"),s(`
...
padding-right: `),n("span",{class:"o"},"auto"),s(";")])],-1)])]),_:1})]),_:1})]),_:1})])}}};export{V as default};
