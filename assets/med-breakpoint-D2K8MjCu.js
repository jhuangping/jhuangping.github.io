import{_ as x,a as c,b as v,c as S,d as g}from"./TabItem-BAQxWGe5.js";import{_ as b}from"./LatticeTable-B0Naatzu.js";import{_}from"./LatticeHeadline-0FdPbW1y.js";import{r as $,c as w,e as a,i as C,a as l,s as e,b as M,A as s}from"./index-XeVrB2dC.js";const N={__name:"med-breakpoint",setup(y){const i=["Mixin 名稱","功能","參數"],m=$([{cells:['<code>med-max(<span class="opa">$media</span>)</code>',"建立 max-width Media Query","<code>$media</code>：斷點名稱或 px"]},{cells:['<code>med-min(<span class="opa">$media</span>)</code>',"建立 min-width Media Query","<code>$media</code>：斷點名稱或 px"]},{cells:['<code>med-range(<span class="opa">$max, $min</span>)</code>',"建立 範圍寬度 Media Query","<p><code>$max</code>：最大寬度</p><p><code>$min</code>：最小寬度</p>"]},{cells:['<code>med-max-h(<span class="opa">$size</span>)</code>',"建立 max-height Media Query","<code>$size</code>：最大高度"]},{cells:['<code>med-min-h(<span class="opa">$size</span>)</code>',"建立 min-height Media Query","<code>$size</code>：最小高度"]},{cells:['<code>med-range-h(<span class="opa">$max, $min</span>)</code>',"建立 範圍高度 Media Query","<code>$max</code>：最大高度<br><br><code>$min</code>：最小高度"]}]);return(z,n)=>{const r=_,f=b,o=v,d=c,p=g,u=S,t=x;return M(),w("div",null,[a(r,{title:"breakpoint",subtitle:"media"}),n[24]||(n[24]=C("<p>統一管理響應式斷點，讓響應式設計更簡潔、可維護</p><p>提供了 寬度 <code>(width)</code> 與 高度 <code>(height)</code> 兩大類的 Media Query 建立方式，並支援： </p><ul><li>max-width / min-width / range-width</li><li>max-height / min-height / range-height</li><li>斷點名稱對應：可從 <code>$useBreakpoints</code> 取得設定好的斷點值</li><li>自訂數值：若斷點名稱不存在，可直接傳入 px 數值</li></ul><hr><h2>Mixin 說明</h2>",5)),a(f,{columns:i,rows:m.value},null,8,["rows"]),n[25]||(n[25]=l("p",null," ",-1)),n[26]||(n[26]=l("hr",null,null,-1)),n[27]||(n[27]=l("h2",null,"範例 (Example)",-1)),n[28]||(n[28]=l("h3",null,"Max-width",-1)),a(t,{value:"0"},{default:e(()=>[a(d,null,{default:e(()=>[a(o,{value:"0"},{default:e(()=>[...n[0]||(n[0]=[s("SCSS",-1)])]),_:1}),a(o,{value:"1"},{default:e(()=>[...n[1]||(n[1]=[s("CSS",-1)])]),_:1})]),_:1}),a(u,null,{default:e(()=>[a(p,{value:"0"},{default:e(()=>[...n[2]||(n[2]=[l("pre",null,[l("code",null,[l("span",{class:"o"},".title"),s(` {
