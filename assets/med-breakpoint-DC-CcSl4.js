import{_,a as v,b as g,c as S,d as b}from"./TabItem-DojJw6c7.js";import{_ as $}from"./LatticeBlock-DLnlnv5b.js";import{_ as w}from"./LatticeTable-BTl1O2MD.js";import{_ as C}from"./LatticeScssCode-DmvcEpOQ.js";import{_ as M}from"./LatticeHeadline-Bci94iqe.js";import{r as y,c as z,e as a,i as k,a as s,s as e,b as Q,A as l}from"./index-Dhf5dUn1.js";const A={__name:"med-breakpoint",setup(T){const m=["Mixin 名稱","功能","參數"],r=y([{cells:['<code><span class="b">med-max</span>(<span class="r">$media</span>)</code>',"建立 max-width Media Query","<code>$media</code>：斷點名稱或 px"]},{cells:['<code><span class="b">med-min</span>(<span class="r">$media</span>)</code>',"建立 min-width Media Query","<code>$media</code>：斷點名稱或 px"]},{cells:['<code><span class="b">med-range</span>(<span class="r">$max, $min</span>)</code>',"建立 範圍寬度 Media Query","<p><code>$max</code>：最大寬度</p><p><code>$min</code>：最小寬度</p>"]},{cells:['<code><span class="b">med-max-h</span>(<span class="r">$size</span>)</code>',"建立 max-height Media Query","<code>$size</code>：最大高度"]},{cells:['<code><span class="b">med-min-h</span>(<span class="r">$size</span>)</code>',"建立 min-height Media Query","<code>$size</code>：最小高度"]},{cells:['<code><span class="b">med-range-h</span>(<span class="r">$max, $min</span>)</code>',"建立 範圍高度 Media Query","<code>$max</code>：最大高度<br><br><code>$min</code>：最小高度"]}]);return(B,n)=>{const c=M,f=C,x=w,i=$,o=g,d=v,p=b,t=S,u=_;return Q(),z("div",null,[a(c,{title:"breakpoint",subtitle:"media"}),n[30]||(n[30]=k("<p>統一管理響應式斷點，讓響應式設計更簡潔、可維護</p><p>提供了 寬度 <code>(width)</code> 與 高度 <code>(height)</code> 兩大類的 Media Query 建立方式，並支援： </p><ul><li>max-width / min-width / range-width</li><li>max-height / min-height / range-height</li><li>斷點名稱對應：可從 <code>$useBreakpoints</code> 取得設定好的斷點值</li><li>自訂數值：若斷點名稱不存在，可直接傳入 px 數值</li></ul><hr><br>",5)),a(f,{code:["med-max()","med-min()","med-range()","med-max-h()","med-min-h()","med-range-h()"]}),a(i,{label:"Mixin 說明"},{default:e(()=>[a(x,{columns:m,rows:r.value},null,8,["rows"])]),_:1}),n[31]||(n[31]=s("p",null," ",-1)),a(i,{label:"範例 (Example)"},{default:e(()=>[n[24]||(n[24]=s("h4",null,"Max-width",-1)),a(u,{value:"0"},{default:e(()=>[a(d,null,{default:e(()=>[a(o,{value:"0"},{default:e(()=>[...n[0]||(n[0]=[l("SCSS",-1)])]),_:1}),a(o,{value:"1"},{default:e(()=>[...n[1]||(n[1]=[l("CSS",-1)])]),_:1})]),_:1}),a(t,null,{default:e(()=>[a(p,{value:"0"},{default:e(()=>[...n[2]||(n[2]=[s("pre",null,[s("code",null,[s("span",{class:"o"},".title"),l(` {
