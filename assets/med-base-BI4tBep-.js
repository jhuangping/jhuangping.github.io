import{_ as b,a as v,b as x,c as S,d as g}from"./TabItem-CHbyCqO8.js";import{_ as w}from"./LatticeBlock-Dz9ap4dQ.js";import{_ as C}from"./LatticeTable-klrjXbh2.js";import{_ as T}from"./LatticeScssCode-C19MdmRh.js";import{_ as k}from"./LatticeHeadline-K7MKTOjw.js";import{r as B,c as L,e as l,i as $,a as s,s as o,b as N,A as n}from"./index-BNrrEEM2.js";const j={__name:"med-base",setup(V){const c=["Mixin 名稱","適用裝置"],i=B([{cells:['<code><span class="b">active()</span></code>',"手機、平板 (觸控)"]},{cells:['<code><span class="b">hover()</span></code>',"桌機、筆電 (滑鼠)"]},{cells:['<code><span class="b">med</span>(<span class="r">$device</span>)</code>',"依參數切換桌機或手機樣式<br><code>desktop</code> : 桌機、筆電<br><code>mobile</code> : 移動裝置"]}]);return(z,a)=>{const m=k,_=T,f=C,r=w,e=x,t=v,p=g,d=S,u=b;return N(),L("div",null,[l(m,{title:"media",subtitle:"media"}),a[15]||(a[15]=$("<p>依據使用者裝置的 輸入方式 <b>(hover / pointer)</b> 來套用不同的樣式，讓設計能更精準區分桌機、手機、平板或觸控筆的使用情境 </p><ul><li><b>區分互動能力：</b>判斷裝置是否支援 <code>hover</code>，以及指標的精細程度 (<code>fine</code> vs <code>coarse</code>)</li><li><b>提升使用體驗：</b>桌機/筆電可使用 hover 效果；手機/平板則避免 hover，並加大點擊區域</li><li><b>裝置適配：</b>針對觸控筆或特殊裝置 (智慧電視) 提供額外調整 </li></ul><hr><br>",4)),l(_,{code:["active()","hover()","med()"]}),l(r,{label:"Mixin 說明"},{default:o(()=>[l(f,{columns:c,rows:i.value},null,8,["rows"])]),_:1}),a[16]||(a[16]=s("p",null," ",-1)),l(r,{label:"範例 (Example)"},{default:o(()=>[a[12]||(a[12]=s("h4",null,"手機樣式",-1)),l(u,{value:"0"},{default:o(()=>[l(t,null,{default:o(()=>[l(e,{value:"0"},{default:o(()=>[...a[0]||(a[0]=[n("SCSS",-1)])]),_:1}),l(e,{value:"1"},{default:o(()=>[...a[1]||(a[1]=[n("CSS",-1)])]),_:1})]),_:1}),l(d,null,{default:o(()=>[l(p,{value:"0"},{default:o(()=>[...a[2]||(a[2]=[s("pre",null,[s("code",null,[s("span",{class:"o"},".btn"),n(` {
