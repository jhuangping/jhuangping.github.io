import{_ as x,a as c,b as v,c as S,d as g}from"./TabItem-BFPeGtyP.js";import{_ as b}from"./LatticeTable-Dd4FkaPG.js";import{_}from"./LatticeHeadline-QrivTIRq.js";import{r as $,c as w,e as a,i as C,a as l,s as e,b as M,A as n}from"./index-B507jP-v.js";const N={__name:"med-breakpoint",setup(y){const i=["Mixin 名稱","功能","參數"],m=$([{cells:["<code>med-max($media)</code>","建立 max-width Media Query","<code>$media</code>：斷點名稱或 px"]},{cells:["<code>med-min($media)</code>","建立 min-width Media Query","<code>$media</code>：斷點名稱或 px"]},{cells:["<code>med-range($max, $min)</code>","建立 範圍寬度 Media Query","<p><code>$max</code>：最大寬度</p><p><code>$min</code>：最小寬度</p>"]},{cells:["<code>med-max-h($size)</code>","建立 max-height Media Query","<code>$size</code>：最大高度"]},{cells:["<code>med-min-h($size)</code>","建立 min-height Media Query","<code>$size</code>：最小高度"]},{cells:["<code>med-range-h($max, $min)</code>","建立 範圍高度 Media Query","<code>$max</code>：最大高度<br><br><code>$min</code>：最小高度"]}]);return(z,s)=>{const r=_,f=b,d=v,u=c,o=g,p=S,t=x;return M(),w("div",null,[a(r,{title:"breakpoint",subtitle:"media"}),s[24]||(s[24]=C("<p>統一管理響應式斷點，讓響應式設計更簡潔、可維護</p><p>提供了 寬度 <code>(width)</code> 與 高度 <code>(height)</code> 兩大類的 Media Query 建立方式，並支援： </p><ul><li>max-width / min-width / range-width</li><li>max-height / min-height / range-height</li><li>斷點名稱對應：可從 <code>$useBreakpoints</code> 取得設定好的斷點值</li><li>自訂數值：若斷點名稱不存在，可直接傳入 px 數值</li></ul><hr><h2>Mixin 說明</h2>",5)),a(f,{columns:i,rows:m.value},null,8,["rows"]),s[25]||(s[25]=l("p",null," ",-1)),s[26]||(s[26]=l("hr",null,null,-1)),s[27]||(s[27]=l("h2",null,"範例 (Example)",-1)),s[28]||(s[28]=l("h3",null,"Max-width",-1)),a(t,{value:"0"},{default:e(()=>[a(u,null,{default:e(()=>[a(d,{value:"0"},{default:e(()=>[...s[0]||(s[0]=[n("SCSS",-1)])]),_:1}),a(d,{value:"1"},{default:e(()=>[...s[1]||(s[1]=[n("CSS",-1)])]),_:1})]),_:1}),a(p,null,{default:e(()=>[a(o,{value:"0"},{default:e(()=>[...s[2]||(s[2]=[l("pre",null,[l("code",null,[l("span",{class:"o"},".title"),n(` {
